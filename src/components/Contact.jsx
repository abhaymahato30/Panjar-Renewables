...
const Contact = () => {
  ...
  return (
    <section id="contact" className="min-h-screen bg-gradient-to-r from-blue-200 via-green-300 to-pink-300 py-20 px-4">
      <div className="max-w-screen-lg mx-auto text-center">
        ...
        >
          ...
          <div className="flex items-center justify-center space-x-6">
            {/* Founder Image */}
            <img
              src="https://media.licdn.com/dms/image/v2/C4D03AQG16ZBIT-tMLQ/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1638356079943?e=1736380800&v=beta&t=UwbAqoP0qB8Ywe0BwrLuRCrsWD6cwh8rFoWFIpvyKBk"
              alt="Founder"
