...
const FAQ = () => {
  ...
  const toggleAnswer = (index) => {
    if (activeIndex === index) {
      setActiveIndex(null); // Close the answer if clicked again
    } else {
      setActiveIndex(index); // Open the corresponding answer
    }
  };

  // Updated FAQ data for Panjar Renewables with highlighted text
  const faqData = [
    {
